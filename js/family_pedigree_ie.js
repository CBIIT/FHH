...
function createDialog_Ie() {
    ...
    if($("#optionsPanel").dialog( "isOpen" ) == true) {
        ...
        + "<tr>"
        + "<td>"
        + "<input id='bmi' type='checkbox' name='chk_group' value='bmi' onclick='HideInfo_Ie()' checked />Show my personal information in the report (such as Date of Birth, Height, or Weight)<br />"
        + "<input id='names' type='checkbox' name='chk_group' value='names' onclick='HideInfo_Ie()' checked />Show names of family members in the report<br />"
